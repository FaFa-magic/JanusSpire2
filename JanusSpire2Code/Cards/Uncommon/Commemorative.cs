...
public sealed class Commemorative() : JanusCardModel(1, CardType.Skill, CardRarity.Uncommon, TargetType.Self)
{
    ...
    public override IEnumerable<CardKeyword> CanonicalKeywords => [CardKeyword.Exhaust, JanusKeywords.Transcribe];
